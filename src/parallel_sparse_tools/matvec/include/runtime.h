...
enum class ReturnState {
  ...
  INVALID_DIAGS_TYPE,
  INVALID_DIAGS_NDIM,
  DIAGS_NOT_C_CONTIGUOUS,
  INVALID_OFFSETS_TYPE,
  OFFSETS_NOT_C_CONTIGUOUS,
  INVALID_OFFSETS_NDIM,
  MISMATCH_DIAGS_OFFSETS
};
...
void define_runtime(py::module_ &m) {
  py::enum_<ReturnState>(m, "ReturnState")
      ...
      .value("INVALID_DIAGS_TYPE", ReturnState::INVALID_DIAGS_TYPE)
      .value("INVALID_DIAGS_NDIM", ReturnState::INVALID_DIAGS_NDIM)
      .value("DIAGS_NOT_C_CONTIGUOUS", ReturnState::DIAGS_NOT_C_CONTIGUOUS)
      .value("INVALID_OFFSETS_TYPE", ReturnState::INVALID_OFFSETS_TYPE)
      .value("OFFSETS_NOT_C_CONTIGUOUS", ReturnState::OFFSETS_NOT_C_CONTIGUOUS)
      .value("INVALID_OFFSETS_NDIM", ReturnState::INVALID_OFFSETS_NDIM)
      .value("MISMATCH_DIAGS_OFFSETS", ReturnState::MISMATCH_DIAGS_OFFSETS);
}
