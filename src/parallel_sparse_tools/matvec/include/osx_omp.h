...
/*!
 * The `omp_target_memcpy_async` routine asynchronously performs a copy between
...
extern int __KAI_KMPC_CONVENTION omp_target_memcpy_async(void *, const void *,
                                                         ...
                                                         omp_depend_t *);
/*!
 * The `omp_target_memcpy_rect_async` routine asynchronously performs a copy
...
extern void *__KAI_KMPC_CONVENTION
omp_realloc(void *ptr, size_t size,
