...
T csr_trace(const I n_row, const I n_col, const I Ap[], const I Aj[],
            const T Ax[]) {
...
template <class I, class T>
npy_intp csr_shift_diag_pass1(const T shift, const I n_row, const I n_col,
  ...
  for (I i = 0; i < N; i++) {
    ...
    if (!row_has_diag) { // row has no diagonal element hence shift will add
                         // one.
      nnz_new++;
    }
  }
...
void csr_shift_diag_pass2(const T shift, const I n_row, const I n_col,
                          const I Ap[], const I Aj[], const T Ax[], J Bp[],
                          J Bj[], T Bx[]) {
...
template <class I, class T>
double csr_1_norm(
    const I n_row, const I n_col, const I Ap[], const I Aj[],
